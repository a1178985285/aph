...
if (typeof jQuery === "undefined") {
    ...
    MultiTabs.prototype = {
        ...
        activeMenu: function(navTab) {
            ...
            if ($navObj.parents('ul.nav-subnav').last().is(':hidden')) {
                $navObj.parents('ul.nav-subnav').last().slideDown(500, function(){
		            ...
		            var scrollHeight  = 0,
                        $scrollBox    = $('.lyear-layout-sidebar-scroll-text'),
                    ...
                    if ($navHasSubnav.length == 1) {
                        ...
                        if (typeof($viSubHeight) != 'undefined' && $viSubHeight != null) {
                            ...
                            $scrollBox.animate({scrollTop: scrollHeight}, 3000);
                        } else {
                            if ((thisScroll + boxHeight - $scrollBox[0].scrollHeight) == 0) {
                                scrollHeight = thisScroll - thisSubHeight;
                                $scrollBox.animate({scrollTop: scrollHeight}, 1300);
                            }
                        }
                    }
                });
        ...
        _listen: function () {
            ...
            // 2020-6-29change for lv
            $el.tabContent.css('paddingTop', '46px');
